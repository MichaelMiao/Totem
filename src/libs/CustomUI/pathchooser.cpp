...
namespace CustomUI {
const char * const PathChooser::browseButtonLabel =
#ifdef Q_OS_MAC
	QT_TRANSLATE_NOOP("CustomUI::PathChooser", "Choose...");
#else
	QT_TRANSLATE_NOOP("CustomUI::PathChooser", "Browse...");
#endif
...
{
	QStringList ls = QStandardPaths::standardLocations(QStandardPaths::DocumentsLocation);
	if (!ls.empty())
		return ls.front();
    return "";
}
