...
ProgressItemWidget::ProgressItemWidget( const QPixmap &indicatorPixmap, const QString &title, QWidget *parent /*= 0*/ )
	: QWidget(parent),
...
void ProgressItemWidget::setIndicatorVisible( bool visible )
{
...
void ProgressItemWidget::setWordWrap( bool wrap )
{
