...
TOTEM_UTILS_EXPORT QString settingsKey(const QString &category);

// Return the common prefix part of a string list:
// "C:\foo\bar1" "C:\foo\bar2"  -> "C:\foo\bar"
TOTEM_UTILS_EXPORT QString commonPrefix(const QStringList &strings);

// Return the common path of a list of files:
// "C:\foo\bar1" "C:\foo\bar2"  -> "C:\foo"
TOTEM_UTILS_EXPORT QString commonPath(const QStringList &files);


class TOTEM_UTILS_EXPORT AbstractMacroExpander {
public:
...
class TOTEM_UTILS_EXPORT AbstractQtcMacroExpander : public AbstractMacroExpander {
public:
...
TOTEM_UTILS_EXPORT void expandMacros(QString *str, AbstractMacroExpander *mx);
TOTEM_UTILS_EXPORT QString expandMacros(const QString &str, AbstractMacroExpander *mx);
