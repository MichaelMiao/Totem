...
struct TOTEM_UTILS_EXPORT SynchronousProcessResponse
{
    enum Result {
...
TOTEM_UTILS_EXPORT QDebug operator<<(QDebug str, const SynchronousProcessResponse &);

class TOTEM_UTILS_EXPORT SynchronousProcess : public QObject
{
    Q_OBJECT
public:
    enum Flags {
