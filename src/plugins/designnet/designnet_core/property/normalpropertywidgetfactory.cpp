...
#include "../widgets/pathdialogpropertywidget.h"
#include "../widgets/ipropertywidget.h"
#include "../widgets/optionpropertywidget.h"
...
IPropertyWidget *NormalPropertyWidgetFactory::createWidget(Property *property,
                                                         QWidget *parent)
{
	if(property->propertyType() == DesignNet::Constants::PROPERTY_TYPE_PATHDIALOG)
	{
	...
	else if(property->propertyType() == DesignNet::Constants::PROPERTY_TYPE_OPTION)
	{
		OptionProperty *optionProperty = qobject_cast<OptionProperty*>(property);
		if(optionProperty)
			return new OptionPropertyWidget(optionProperty, parent);
	}
	else if(property->propertyType() == DesignNet::Constants::PROPERTY_TYPE_DOUBLERANGE)
	{
	...
	else if(property->propertyType() == DesignNet::Constants::PROPERTY_TYPE_BOOL)
	{
